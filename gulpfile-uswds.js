...
const PROJECT_SASS_SRC = "./src/css/uswds";

// Images destination
const IMG_DEST = "./src/images/uswds";

// Fonts destination
const FONTS_DEST = "./src/fonts/uswds";

// Javascript destination
const JS_DEST = "./src/js/uswds";

// Compiled CSS destination
const CSS_DEST = "./build/css/uswds";
